...
export const metadata = {
  title: "Modifier l'article – Administration – Wuvè Zyé",
  description: "Modifier un article de blog existant.",
}
...
export default async function EditPostPage({ params }: PageProps) {
  ...
  if (!user) {
    redirect(`/login?redirect=/admin/blog/${id}/edit`)
  }
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-zinc-900 text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-bold">Modifier l'article</h1>
          <p className="mt-2 text-white/70 line-clamp-1">{post.title}</p>
        </div>
      </section>
